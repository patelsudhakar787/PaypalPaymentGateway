package com.example.rlard008.hr_app.localdb;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query="create table reportdata(taskname text primary key,role text,starttime text,pausetime text,resumetime text,stoptime text,timetaken integer,status text,checkbtn text,process text,startcolor text,stopcolor text)";
        db.execSQL(query);
        Log.e("DB","created");
    ...
    public ArrayList<SaveData> getData()
    {
        ...
        if(cursor.moveToFirst()){
            do {
                ...
                saveData=new SaveData(taskname,role,starttime,pausetime,resumetime,stoptime,timetaken,status,checkbtn,process,startcolor,stopcolor);
