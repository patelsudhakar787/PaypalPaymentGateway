 ...
 */
public class Business_ConsultancyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView=inflater.inflate(R.layout.fragment_business__consultancy, container, false);


        listView = (ListView) itemView.findViewById(R.id.consultancy_listview);
