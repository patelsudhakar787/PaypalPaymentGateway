 ...
 */
public class Find_JobFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_find__job, container, false);

        btn_filter=(Button)itemView.findViewById(R.id.find_Job_btn_filter);

        listView=(ListView)itemView.findViewById(R.id.find_Job_Listview);
