 ...
 */
public class Find_SponserProFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_find__sponser, container, false);



        btn_filter=(Button)itemView.findViewById(R.id.find_sponser_btn_filter);

        listView=(ListView)itemView.findViewById(R.id.find_sponser_Listview);
