...
//        textViewEducation = (TextView) itemView.findViewById(R.id.textviewSkillEducation);
//        textViewPersonalDetails = (TextView) itemView.findViewById(R.id.textviewSkillPersonalDetails);
//        textViewMySkills = (TextView) itemView.findViewById(R.id.textviewSkillMySkills);
//
//
