 ...
 */
public class Mentor_ProgressRatingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemview=inflater.inflate(R.layout.fragment_mentor__progress_rating, container, false);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Mentor_IdeasPitchFragment frg = new Mentor_IdeasPitchFragment();
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction ft = fragmentManager.beginTransaction();
                ft.replace(R.id.mentorContainer,frg);
                ft.commit();
