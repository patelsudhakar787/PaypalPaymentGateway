 ...
 */
public class SIG_ConsultancyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_sig__consultancy, container, false);

        buttonAddCommercializationDetails = (Button) itemView.findViewById(R.id.SIG_AddConsultancyDetails);
