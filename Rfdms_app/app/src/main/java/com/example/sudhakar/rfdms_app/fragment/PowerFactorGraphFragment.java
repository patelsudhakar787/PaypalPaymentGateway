...
public class PowerFactorGraphFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textViewChannelName.setText("PowerFactor");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("channel","PowerFactor");
            ...
            public void onResponse(Call<MyPojo> call, retrofit2.Response<MyPojo> response) {
                if(response.isSuccessful()) {
                    ...
                    for (int i = 0; i < feeds.size(); i++) {
                        ...
                        powerfactor = feeds1.getField4();
                        Log.e("voltage", "" + powerfactor);
                        if (powerfactor != null) {
                            arraylistgraphdata.add(Float.parseFloat(powerfactor));
