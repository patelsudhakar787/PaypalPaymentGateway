...
import com.example.sudhakar.amled.adapter.DrawerListAdapter;
import com.example.sudhakar.amled.fragment.WelcomeFragment;
...
public class WelComePageActivity extends AppCompatActivity {
    ...
    private static final String message = "No Internet";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isCon= com.example.sudhakar.amled.api.Network.isNwConnected(this);
    ...
    public void setDrawerLayout()
    {
        ...
        arrayListdata.add(new com.example.sudhakar.amled.pojo.Drawerdata(R.drawable.services,"Services"));
        arrayListdata.add(new com.example.sudhakar.amled.pojo.Drawerdata(R.drawable.about1,"About Us"));
        arrayListdata.add(new com.example.sudhakar.amled.pojo.Drawerdata(R.drawable.help,"Help"));
        Log.e("arraylist",""+arrayListdata);


        //setting adapter to drawer
        DrawerListAdapter adapter=new DrawerListAdapter(com.example.sudhakar.amled.activities.WelComePageActivity.this,arrayListdata);
