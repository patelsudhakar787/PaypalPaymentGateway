 ...
 */
public class Mentor_AddExpDetailsFragment extends Fragment {


    EditText editTextDesignation,editTextCompany,editTextLocation,editTextFromDate,editTextToDate,editTextDesc;

    Button buttonSaveDetails,buttonCancelDetails;


    private static final String Update_URL = "http://10.10.0.220:8081/STBI/MentorProfessionalExperience";
...
//    String Grade;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_mentor__add_exp_details, container, false);

        editTextDesignation = (EditText) itemView.findViewById(R.id.addDetailsSchool);
        editTextCompany = (EditText) itemView.findViewById(R.id.addDetailsDegree);
        editTextLocation = (EditText) itemView.findViewById(R.id.addDetailsField);
        ...
        buttonSaveDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Company_Name = editTextCompany.getText().toString();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Update_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.e("Exp Update_URL","update"+Update_URL);
                        Log.e("Exp Add detai response","regrg"+response);
                        //  try {
...
//                        }
            ...
            protected Map<String,String> getParams(){
                ...
                params.put(KEY_Company_Name, Company_Name);
