 ...
 */
public class Investor_ExperienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_investor__experience, container, false);

        buttonAddDetails = (Button) itemView.findViewById(R.id.investor_Exp_AddDetails);
