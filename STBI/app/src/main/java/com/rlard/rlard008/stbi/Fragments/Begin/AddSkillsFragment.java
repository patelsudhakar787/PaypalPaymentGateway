...
public class AddSkillsFragment extends Fragment {
    ...
    private static final String Update_URL = " http://139.59.78.30:8080/BeginmyStartup/UserAddskill";

    public static final String KEY_Name = "skills";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_add_skills, container, false);
