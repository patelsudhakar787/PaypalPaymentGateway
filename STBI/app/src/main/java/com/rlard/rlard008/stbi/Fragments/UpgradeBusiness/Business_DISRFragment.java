 ...
 */
public class Business_DISRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView=inflater.inflate(R.layout.fragment_business__disr, container, false);

        listView=(ListView)itemView.findViewById(R.id.DISR_listview);
