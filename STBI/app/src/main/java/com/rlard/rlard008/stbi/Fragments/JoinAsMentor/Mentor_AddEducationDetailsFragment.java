 ...
 */
public class Mentor_AddEducationDetailsFragment extends Fragment {
    ...
    private static final String Update_URL = "http://10.10.0.220:8081/STBI/MentoraAddEducation";

    public static final String KEY_Name = "sname";
    public static final String KEY_Email= "email";
    public static final String KEY_Degree = "degree";
    //public static final String KEY_UserID = "userid";
    public static final String KEY_Field = "study";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_mentor__add_education_details, container, false);
