 ...
 */
public class Mentor_ExperienceFragment extends Fragment {

    Button buttonAddDetails;

    ListView listView;

    String Name,Designation,Location,TimeFrom,TimeTo,Desc;

    String mentorId;
    String Experience_Details_URL;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_mentor__experience, container, false);

        buttonAddDetails = (Button) itemView.findViewById(R.id.mentor_Exp_AddDetails);

        listView=(ListView)itemView.findViewById(R.id.mentor_experience_listView);
        ...
        Experience_Details_URL = "http://10.10.0.220:8081/STBI/MentorDashBoardServlet?is_Mobile=1&module=personalexperience&mid="+mentorId;//begin-dashboard.jsp?email=sheetal.khankar@rlard.com&is_Mobile=1";
        //STBI/MentorPersonalExperienceServlet?is_Mobile=1&mid=100
        Log.e("Existing_Ideas_URL",""+Experience_Details_URL);
        experienceDetails();
        ...
        buttonAddDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Mentor_AddExpDetailsFragment frg=new Mentor_AddExpDetailsFragment();
    ...
    public void experienceDetails() {

        StringRequest stringRequest = new StringRequest(Experience_Details_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                ...
                                //,
                                Name=jsonObject1.getString("companyname");
                             ...
                             //   Grade=jsonObject1.getString("grade");
                                ...
                                details = new BeginEducationDetails(Name,Designation,Location,TimeFrom,TimeTo,Desc);
...
//                            textViewGender.setText(Gender);
    ...
    class ListViewAdapter extends ArrayAdapter<BeginEducationDetails>
    {
        ...
        public ListViewAdapter() {
            super(getActivity(),R.layout.experience_layout_listview,arrayListEducationDetails);
        }
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            convertView=inflater.inflate(R.layout.experience_layout_listview,parent,false);
