...
public class Mentor_MyProfileMainFragment extends Fragment {
    ...
    TextView textViewBasicDetails,textViewPersonalDetails,textViewEducation,textViewMySkills,textViewExperience,textViewDesign;//,textViewTraining;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewBasicDetails = (TextView) itemView.findViewById(R.id.textviewMentorBasicDetails);
       ...
       // textViewTraining = (TextView) itemView.findViewById(R.id.textviewMentorTraining);
        ...
        textViewBasicDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Mentor_BasicDetailsFragment frg=new Mentor_BasicDetailsFragment();
