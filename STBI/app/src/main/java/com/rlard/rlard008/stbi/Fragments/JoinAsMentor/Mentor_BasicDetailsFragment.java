 ...
 */
public class Mentor_BasicDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_mentor__basic_details, container, false);
        ...
        Personal_Details_URL = "http://10.10.0.220:8081/STBI/MentorDashBoardServlet?is_Mobile=1&module=basicdetails&mid="+mentorId;//begin-dashboard.jsp?email=sheetal.khankar@rlard.com&is_Mobile=1";
//STBI/MentorBasicServlet?is_Mobile=1&mid=100
...
//                                jsonObject1=jsonArray.getJSONObject(i);
                            ...
                            Aadhar=jsonObject1.getString("adharno");
                            Gender=jsonObject1.getString("gender");

                            tempAddresss=jsonObject1.getString("temporaryaddress");
                            perAddress=jsonObject1.getString("temporaryaddress");
