 ...
 */
public class InstituteHackathonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_institute_hackathon, container, false);

        btn_filter=(Button)itemView.findViewById(R.id.hack_btn_filter);

        listView=(ListView)itemView.findViewById(R.id.hack_institute_Listview);
