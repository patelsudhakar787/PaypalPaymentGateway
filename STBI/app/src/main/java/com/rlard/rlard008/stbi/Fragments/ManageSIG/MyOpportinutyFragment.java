 ...
 */
public class MyOpportinutyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_my_opportinuty, container, false);



        btn_filter=(Button)itemView.findViewById(R.id.opp_btn_filter);

        listView=(ListView)itemView.findViewById(R.id.project_Listview);
