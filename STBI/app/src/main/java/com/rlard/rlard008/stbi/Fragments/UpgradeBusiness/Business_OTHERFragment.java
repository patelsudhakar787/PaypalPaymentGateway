 ...
 */
public class Business_OTHERFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView=inflater.inflate(R.layout.fragment_business__other, container, false);

        listView=(ListView)itemView.findViewById(R.id.OTHER_listview);
