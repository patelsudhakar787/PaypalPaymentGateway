									        ...
									        <form action="./LoginController" method="post"> 
												  ...
												  <div class="input-group">
												   ...
												   <div class="fload_right">
												    	...
												    	<a href="font.jsp" target="_blank" class="btn btn-info   active">FONTS</a>
												    	<a href="begin-dashboard.jsp" target="_blank" class="btn btn-warning active">Next</a>
												  </div><br><hr>
												  <div class="fload_right">
								   		   ...
								   		   <div class="panel-body">
													  ...
													  <div class="form-group ">
														    ...
														    <div class="col-sm-8  has-feedback">
														      <input class="form-control" id="focusedInput" type="text" value="" ng-model="fname"  name="fname" ng-pattern="stringonly" required>
